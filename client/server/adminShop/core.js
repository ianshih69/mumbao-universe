...
export async function handleWarehouseMediaUploadAction(req, res) {
  const adminContext = await requireAuthenticatedAdmin(req);
  return await handleWarehouseMediaUpload(req, res, adminContext);
}

export async function handleWarehouseMediaAction(req, res) {
  const adminContext = await requireAuthenticatedAdmin(req);
  return await handleWarehouseMedia(req, res, adminContext);
}

export async function handleAdminUsersAction(req, res) {
  const adminContext = await requireAuthenticatedAdmin(req);
