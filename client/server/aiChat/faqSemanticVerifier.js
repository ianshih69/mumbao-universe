...
const selectorSystemRules = [
  ...
  "Before selecting, compare the intent slots: the core entity or topic, the core action, and any material time, location, or constraint.",
  "A shared noun or similar wording alone is not enough to establish the same intent.",
  "If the core actions differ, do not select that FAQ. Shipping, courier delivery, or receiving on someone's behalf is not on-site storage or temporary holding.",
  "Likewise, booking cancellation is not refund completion, permission to stay is not lodging pricing, and check-in time is not check-out time.",
  "If FAQ metadata does not clearly cover the query's core action and material slots, return action none rather than inferring a policy.",
