    ...
    <section id="experience" className="scroll-mt-[120px] py-24 bg-[#F5F5F5]">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          >
            <Link
              href="/experience/slow-guide"
              className="group relative block overflow-hidden w-full aspect-[4/3] md:aspect-auto md:h-[600px] bg-white shadow-lg hover:shadow-2xl transition-shadow duration-500 cursor-pointer"
            >
              <div className="absolute inset-0">
                <img
