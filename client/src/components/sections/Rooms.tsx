                        ...
                        {room.zodiacIcons && room.zodiacIcons.length > 0 && (
                          <span
                            className={`inline-flex items-center overflow-visible ${
                              room.zodiacIcons.some((icon) => icon.src.includes("/Gemini"))
                                && room.zodiacIcons.some((icon) => icon.src.includes("/Aquarius"))
                                ? "mr-3 gap-3 md:mr-3.5"
                                : "mr-2.5 gap-2.5 md:mr-4 md:gap-3"
                            }`}
                          >
