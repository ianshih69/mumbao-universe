...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    category: "Preview",
    date: "2026.07",
    title: "慢慢蒔光 2026 年 11 月試營運籌備中",
    excerpt:
      "慢慢蒔光 STime Villa 正在為 2026 年 11 月試營運做最後準備，包含空間整理、房型體驗、入住動線與服務細節，期待與旅人慢慢相見。",
    detailTitle: "在正式迎接旅人之前，先把每一個細節慢慢準備好",
    content: [
      "慢慢蒔光 STime Villa 正在為 2026 年 11 月試營運進行最後籌備。從公共空間、房型體驗、入住動線到服務細節，我們希望每一段停留都能保有安靜、自在與被好好接住的感覺。",
      "這裡不是急著完成的地方，而是一座慢慢整理、慢慢靠近旅人的白雲基地。未來將提供適合家庭、朋友與毛孩同行的包棟住宿體驗，讓旅人在山與田之間，留下一段真正能放慢的時間。",
      "試營運相關日期、訂房方式與入住資訊，將以官網最新公告為準。",
    ],
    image: "/images/News/News-2.JPG",
    alt: "慢慢蒔光 2026 年 11 月試營運籌備中",
  },
  {
    id: 3,
