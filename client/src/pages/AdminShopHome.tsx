...
function SummaryCard({
  ...
  const content = (
    <>
      ...
      {actionLabel && (
        <p className="mt-4 text-sm font-semibold text-[#8b6f5b]">{actionLabel}</p>
      )}
    </>
  );
...
function RecentOrderRow({ order }: { order: AdminDashboardRecentOrder }) {
  ...
  return (
    <a
      href={orderHref}
      className="block rounded-[8px] border border-stone-100 bg-[#fbf7f1] p-4 transition hover:-translate-y-0.5 hover:border-[#b99aa2] hover:bg-[#f4ece2] hover:shadow-sm"
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col gap-3 md:min-w-[280px] md:items-end">
          ...
          <div className="flex flex-wrap items-center gap-3 md:justify-end">
            ...
            <p className="text-base font-semibold text-[#8b6f5b]">
              {formatPrice(order.total)}
            </p>
          </div>
          <span className="inline-flex w-fit items-center rounded-full bg-[#8b6f5b] px-3 py-1.5 text-sm font-semibold text-white">
            查看訂單
          </span>
        </div>
      </div>
            ...
            <section className="rounded-[8px] border border-stone-200 bg-white p-5 shadow-sm">
              <div className="mb-4 flex items-start justify-between gap-3">
                ...
                <a
                  ...
                  className="inline-flex h-9 items-center rounded-full border border-stone-200 bg-white px-3 text-sm font-semibold text-[#8b6f5b] transition hover:border-[#b99aa2] hover:bg-[#f4ece2]"
                >
                  查看全部
                </a>
              </div>
          ...
          <aside className="space-y-6">
            <section className="rounded-[8px] border border-stone-200 bg-white p-5 shadow-sm">
              <div className="mb-4 flex items-start justify-between gap-3">
                ...
                <a
                  href="/admin/shop/inventory"
                  className="inline-flex h-9 shrink-0 items-center rounded-full border border-amber-200 bg-white px-3 text-sm font-semibold text-amber-700 transition hover:border-amber-300 hover:bg-amber-50"
                >
                  前往庫存
                </a>
              </div>
